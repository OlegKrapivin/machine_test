...
def test_drive_and_reverse_to_30(api_terminal, result, gear1, gear2):
    ...
    with allure.step("--> Expected result."):
        assert api_terminal.get_signal_state(SignalIds.ACC_PEDAL_POS)['Value'] == AccPedalConsts.STR_THIRSTY, \
